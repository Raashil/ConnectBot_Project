...
class Chain:
    def __init__(self):
        self.llm = ChatGroq(temperature=0, groq_api_key=os.getenv("Ggsk_O2ZrRpKiS5o5uZ4he9JYWGdyb3FYYbqhrWNrdNyERqdaxgEGeIyS"), model_name="llama-3.1-70b-versatile")
    ...
    def write_mail(self, job, links):
        prompt_email = PromptTemplate.from_template(
            ...
            ### INSTRUCTION:
            You are Raashil & Sujith, a business development executive at RaSu Tech. RaSu Tech is an AI Consulting company dedicated to facilitating
